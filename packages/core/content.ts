...
export const PAGES = {
  ...
  predictions: {
    ...
    likesEmptyState: "Todavía no hay peleadores para likear.",
...
export const ADMIN_CONTROL = {
  ...
  rouletteModeTitle: "Modo de sorteo",
  rouletteModeRandom: "Aleatorio",
  rouletteModeBalanced: "Equilibrado",
  rouletteModeRandomHint: "Empareja al azar entre quienes todavia no tuvieron su 1v1.",
  rouletteModeBalancedHint: "Busca el combate mas renido posible (segun Habilidad 1v1) entre quienes todavia no tuvieron su 1v1.",
  rouletteExcludeTitle: "Excluir del sorteo 1v1",
  rouletteExcludeHint: "Tildá quien NO queres que pueda salir sorteado en el proximo 1v1 (ej: ya peleo, esta ausente). No afecta su ficha ni otros combates, solo el calculo de la ruleta.",
  rouletteMarkAllCta: "Excluir todos",
  rouletteUnmarkAllCta: "Incluir todos",
  rouletteExcludedHint: (excluded: number, total: number) => `${excluded} de ${total} excluidos. Disponibles para el sorteo: ${total - excluded}.`,
  rouletteNotEnoughAvailable: "Se necesitan al menos 2 participantes disponibles (sin excluir) para sortear.",
